  ...
  return (
    <section className="relative w-full h-[100%] flex items-center ">
      <div className="bg-transparent flex flex-row border-purple-scale-stroke border text-white w-full h-[512px]  ">
        ...
        <div
          className={` flex-col  justify-center gap-10 w-auto  items-center pl-20 pr-[120px] ${
            openMenu === null ? "flex" : "hidden"
          }`}
        >
        ...
        {Data &&
          Data.map((item, index) => (
            ...
            >
              ...
              <div
                className={`flex-col  justify-center gap-10 w-auto  items-start pl-20 pr-[120px] ${
                  openMenu === index ? "flex" : "hidden"
                }`}
              >
                <h2 className="font-Inter font-bold text-2xl   ">
                  {item.titulo}
