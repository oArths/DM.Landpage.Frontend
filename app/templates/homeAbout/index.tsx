          ...
          <div className="flex justify-between gap-[5%]">
            <div className="flex flex-col flex-1 gap-12">
              <div className="flex flex-col gap-4">
                ...
                <span className="font-normal   font-DMSans text-grey-scale-off-white text-lg">
                  ...
                  Engineering, Data Science e Automação Robótica. Nosso propósito
                  é ajudar empresas e profissionais a se desenvolverem na área de
                  dados e gerar transformação digital.
                  <br />
                  <br />
                  Na Data Mastery Tech, estamos comprometidos com a excelência e a
                  inovação, buscando transformar o cenário tecnológico e
              ...
              <div className="flex flex-col gap-4">
                ...
                <span className="font-normal   font-DMSans text-grey-scale-off-white text-lg">
                  Ser referência na transformação digital, capacitando empresas e
                  indivíduos a atingirem seu potencial máximo através do uso
            ...
            <div className="flex flex-col flex-1 gap-12">
              <div className="flex flex-col gap-4">
                ...
                <span className="font-normal   font-DMSans text-grey-scale-off-white text-lg">
                  Capacitar empresas e profissionais a tomar decisões baseadas em
                  dados, promovendo a inovação e a eficiência através de soluções
                  tecnológicas avançadas e educação de qualidade. Nosso
                  compromisso é com o desenvolvimento contínuo, a excelência em
                  serviços e a geração de impacto social positivo no Brasil.
                </span>
              </div>
              <div className="flex flex-col gap-4">
                <h2 className="font-bold font-Inter text-2xl text-grey-scale-off-white text-left w-full">
                ...
                <span className="font-normal   font-DMSans text-grey-scale-off-white text-lg">
                  <ul className="list-disc list-inside">
                    <li>
                      Inovação: Buscamos constantemente novas maneiras de resolver
                      problemas e melhorar processos. Excelência: Comprometemo-nos
                      a entregar serviços e cursos de alta qualidade.
                    </li>
                    <li>
                    ...
                    <li>
                      Colaboração: Acreditamos no poder do trabalho em equipe para
