  ...
  return (
    <section id={id} className="relative flex items-center h-[90dvh] w-full">
      <span className="flex flex-col items-center justify-center w-full gap-10 absolute top-[20%] z-20">
        <p className="font-Inter font-extralight text-base text-grey-scale-text tracking-widest">
      ...
      <div className="bg-primary-indigo z-[15] blur-3xl absolute opacity-20 -bottom-60 left-[80%] w-[25vw] h-[25vw] rounded-full" />
